function men_spindledetection_plots_viewer_20200415()
...
ylabel('band-filtered', 'fontsize', YLABELSIZE)
grid on
axis tight
set(gca,'Xticklabel',[])
set(gca,'YTickLabel',a,'fontsize',YTICKFONTSIZE,'FontWeight',YTICKFONTWEIGHT)
...
ylabel(sprintf('raw EEG #%d', eegNum), 'fontsize', YLABELSIZE)
grid on
axis tight
set(gca,'Xticklabel',[])
set(gca,'YTickLabel',a,'fontsize',YTICKFONTSIZE,'FontWeight',YTICKFONTWEIGHT)
...
ylabel('raw EMG', 'fontsize', YLABELSIZE)
