...
function [sigmaMatch, sigmaMatch_mean, sigmaMatch_std, sigmaMatch_times, matchesi] = get_sigma_transition_match_v3(sigmaMatch_s_before_and_after, epoch_length_s, sample_times, band_timeseries, y_score, a, b)
