function [band_power_timeseries, total_power_timeseries, sample_times] = compute_bands_power_timeseries_unnormalized(settings, spectrogram, spectrogram_freq, bands)
